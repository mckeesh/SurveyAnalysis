...
class Q19Analyzer:
    ...
    def analyze(self, participants, ignoreOtherRole=True):
        ...
        for subquestion in subquestions:
            ...
            rankingsFile.write("Answer, %s\n" % Q19.getAnswerTitle(subquestion.answer))
    ...
    def getResponseCounts(self, participants):
        ...
        scoreSums = [self._blankAnswerDict(participants[0].q19) for x in range(len(participants[0].q19.listed))]
        for participant in participants:
            q19 = participant.q19.listed
    ...
    def compareRoles(self, roles1, roles2, participants):
        ...
        return Comparison(roles1, roles2, "Q19", comparison)
    ...
    def createDirs(self):
        ...
        resultsDirectory = dir_path + "/results/Q19/" 
    ...
    def createResultsFile(self, fileName):
        dir_path = os.path.dirname(os.path.realpath(__file__))
        resultsFile = dir_path + "/results/Q19/" + fileName
